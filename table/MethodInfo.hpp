...
namespace NTable {
    ...
    public:
        CMethodInfo() = delete;
        CMethodInfo(const std::shared_ptr<const NNodes::CMethod> &method, const CSymbol *className);
        ...
        const std::vector<const CSymbol *> &GetPositionParametersType() const;
    private:
        const CSymbol *type;
        const CSymbol *name;
        ...
        std::vector<const CSymbol *> positionParametersType;
